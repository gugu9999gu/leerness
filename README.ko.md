...
[![npm](https://img.shields.io/npm/v/leerness)](https://www.npmjs.com/package/leerness) · ![MCP tools](https://img.shields.io/badge/MCP--tools-88-blue) · **런타임 의존성 0** · **install-script 0** · offline-first · Node ≥ 18 · MIT
