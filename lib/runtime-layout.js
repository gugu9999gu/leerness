...
// clarify.previewCmd and preview-serve.buildServeWorkspace create this exact
// directory. The direct builder does not require previews.json. Admission
// checks only its kind; the domain writer still validates each output path.
const STANDALONE_STORE_DIRECTORIES = new Set(['previews']);
