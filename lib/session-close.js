...
module.exports = { sessionClose: require('./runtime-writes').projectWriter(sessionClose), _upsertAutoLines, _executionProvenanceSummary };   // 1.36.98: 보존 규칙을 selftest 가 직접 검증할 수 있게 노출
