...
### 2026-09-02 — 공급자 상태는 설치·활성·인증·모델 호출권한·잔여량을 분리하고 관측되지 않은 값은 추정하지 않는다
...
### 2026-09-04 — Legacy role assignment writes stay schema v1 and role decisions commit against revisions
- Decision: Legacy role assignment writes stay schema v1 and role decisions commit against revisions
