...
Last generated: 2026-09-05T21:59:31.177Z
...
- T-0179 T-0175 사전 설계: runtime reader/writer 분류와 무손실 마이그레이션 승인 미리보기 → next: P-0021 approved: T-0180 compatibility-only implementation is under validation/publication. T-0175/M-0015 remain incomplete; actual migration B requires separate approval.
...
- T-0175 Worktree runtime 분리와 명시적 호환 마이그레이션 → next: Complete T-0180 validation/publication and T-0181 diagnostic follow-up. Actual migration B needs separate approval.
- T-0180 M-0015-A runtime layout 호환 guard와 읽기 전용 compatibility 진단 → next: Finish the seven same-SHA full CI gates, then publish and independently verify GitHub/npm/site. Public187 remains pending; separately track T-0182 temp-observation correction.
- T-0181 v1.36.186 Windows Node24 encoding selftest CI 재실행 실패 원인 확인 → next: Verify instrumented selftest and actual Windows replacement in supported CI; preserve the original inconclusive errno, do not claim that OS failure reproduced or fixed.
...
## Verification
```
### Standalone producer regression found by whole E2E — 2026-09-06

The test-only successor e8037bc56af61ecfc1205342a53d42f944409192 was pushed to release/1.36.187, CI33989990574. Both fast OS jobs and four release-runtime jobs succeeded; full gates remain pending. Native Ubuntu and Windows both exercised real file-symlink dangling-ledger boundaries: casesRun2/skipped0, standalone workspace_ambiguous and initialized ledger_not_regular_file, whole-tree unchanged, full role80/80. Local exact successor installed cleanroom passed10/10. Its pack SHA1 is820d77461a4ef0c1b63f9b684d584dcc685f6c99, SHA256 b713682849a13767300df0b5a1d381f64604502c3e28396de0b424bc4610058d; any following code/test edit supersedes that artifact. No public187 publication.

Earlier ef41542 CI Linux22/20/18 full E2E completed466/467 (1811/2179/2798 seconds), each with the same sole1.36.74 failure: api/corrupt/json false, seven other predicates true. The local ef41542 whole E2E also reached that failure, and is not a passing final run. Unlike the intentional damaged-Git/dangling-ledger response changes, this is a real regression: the first standalone API skeleton succeeds and creates api-skills, then subsequent operations reject that exact producer directory as foreign.

Independent original-block replay on Windows Node20.20.2 reproduced0/1 plus the original warning footer1/1, all27 CLI children executed and four actual API calls observed, no crawling (FTP and invalid URL reject before HTTP). First alpha skeleton exit0; second beta, corrupt list and invalid URL add each exit1/runtime_layout_incompatible(workspace_ambiguous), stderr empty, and whole target bytes/mtimeNs unchanged. Original block SHA d340092609517c1e0c26db61657b09ed8fc132068a9f7e62aa76fb10f83c9bb8 matches ef41542; six product/probe source signatures stayed fixed. New runtime-layout probe before the product fix also failed158/160, precisely at the new API directory and real round-trip tests. The E2E original expectations remain unchanged; fix exact known-producer admission, not the test contract. Bounded sibling-producer audit is in progress.

The bounded source audit found seven more init-free output directories and twenty top-level file outputs in existing bin producers. Four actual local directory commands and six actual local file commands each succeeded first then failed their next admission; all six initialized file controls succeeded. Seven directory-only writer controls rejected without entering their callbacks and retained bytes/mtimes. Network/provider/credential/server/publication paths were not executed; their exact local output shapes were established from source and metadata-only controls. Conditional feature/enforce/handoff prerequisites remain intact. This inventory is neither a complete external-writer audit nor a migration manifest.

After exact-name/type additions, the unchanged original1.36.74+original warning footer passed2/2 each on Node20.20.2 and26.3.0. Eleven extra observations each passed: API exit[0,0,0,1], distinct IDs, both URL/direction files and original alpha bytes/mtime preserved, corrupted API store unchanged during listing/invalid URL. Healthy commands still update existing usage-stats bookkeeping: an initial auxiliary full-project-no-write assertion was too broad and failed2 controls; narrowing that observation to the requested API store retained the reported whole-project changes. Unsupported-descriptor refusal separately retains full-arena zero-write assertions. No E2E expectation, command or guard was replaced. Six actual source hashes/mtimes remained fixed in each replay; final sixteen owned fixtures were cleaned up.

New fast reader coverage reached199/199 after the directory round-trips, then304/305 after twenty file shapes×five tests and six real file-command repeats. The only failure was the glossary's second build: GLOSSARY_START is not defined. A real initialized control reproduced first exit0/second exit1 with the same error (564/579ms, no timeout/signal); baseline1805da9 source has the same missing imports. Importing the two already-exported glossary marker constants fixes that pre-existing defect without changing its merge algorithm. The unchanged probe then passed305/305 on Node18.20.8 and26.3.0. It asserts no body read/open, exact wrong-kind/link/lookalike/foreign-sibling refusal, first-record retention, requested settings and manual glossary prefix/suffix plus dependency preservation. Source guard now also covers the CLI. Probe SHA ED4C39BB536F345AA1D43868F54744D111391DCDB3B713C4DD4106E44E4C94DD, mtime2026-09-05T21:16:27.0319804Z; both final runs preserved R/bin/probe bytes+mtime and completed owned-fixture cleanup.

Actual independent Codex CLI review01a07372-1fca-7df1-b717-4516e9f788bd exited0/CLEAN on the final supplied delta (input49542/cached18560/output2358). Static only; no independent execution or full-CI endorsement. Parent commands suite exited0 including false-claims202/202, baseline/concurrency, next-actions and command E2E40/40(25.4s). Selftest355/355 passed before the final two-import follow-up. Final core is running on the frozen source. Lint95JS+1JSON, source ratchet, diff check, secrets0 unacknowledged/14 acknowledged, encoding0 passed. Candidate4 Linux20/22 full E2E also failed466/467 at the original API case (2299/2412s); old candidates are not relabeled successful. Product publication remains pending, saved main's five original dirty files remain unchanged.

## 2026-09-06 — Frozen candidate e856c57 (public release pending)

Task: T-0180 / P-0021 / UR-0100. Product SHA e856c57837f90b09048405df6a684190f7a1ff75 was pushed only to release/1.36.187; final CI33993125006. No product/test edits followed the independent final review. Local working tree was clean after prepack and exact artifact checks; subsequent changes in this section are evidence-only and excluded from npm's package file list.
Command: `npm run test:core` (session18196); `npm run test:installed` (session53882); exact-tarball consumer selftest (session7117). Exit: 0 for all three. Final core includes reader305, Windows admission21, writer79, REPL5, Git108, replacement7, encoding2, owned cleanup9, role fallback80, selftest355/355, core52/52(85.8s), mutation75 and MCP presence22/22; earlier stages also completed. Installed cleanroom10/10 includes real pack/install, fresh init, resolver, four concurrent handoffs, legacy migration and the exhaustive command surface. This is not an assertion that a whole local `npm test` or final full E2E has passed.
Artifact: leerness-1.36.187.tgz,110 entries,2281160 bytes,7508391 unpacked; SHA1 ff33b591eed0a2a2d5afa5895c97ccbfca87e820; SHA256 136e2b9dda1d9ce43e0b9029e5cecbb94be74ace9eaebc3999e241eb0bbd4107; integrity sha512-/uI7PagAJvgFRoiGZPiPxBDJ64aEVIK+Ug4XQh/tnU8FwElSadGJtOjEL7hGjsQbcCcSPFEZ2mooQZA69kTPEw==. Owned artifact directory: C:/Users/leehy/AppData/Local/Temp/leerness-pack-187-e856c57-11c9d8d7525a4228af53d94f85ec9603. Exact consumer prefix: C:/Users/leehy/AppData/Local/Temp/leerness-install-187-e856c57-bb4f1b4f77064bc0bab28bc416696496. All110 installed files match current source bytes; package version187, runtime dependencies0 and install lifecycle hooks0. Exact packaged old-client negative probe3/3: installed186 remains unchanged and ignores the future guard; the new client rejects it. This does not prove migration B safe.
Other final checks: prepack exit0, runtime API document contract4 functions/11 fields matched (static only), release publish dry-run exit0/no public action, site711-page build exit0 with current product explicitly selected. Site changes are only generated data/releases.json and data/facts.json. No live-auth or public deployment success is inferred from dry-run/build.
CI snapshot2026-09-05T21:41Z: four release-runtime jobs and Ubuntu fast succeeded; eight jobs still pending, no failure observed yet. All seven full gates and Windows fast must be evaluated on this same SHA. Intermediate local full E2E session74472 started before this candidate and spans product edits; preserve its eventual result separately, never present it as frozen final evidence. Prior failed candidates remain failures. R-0002/publication and T-0180 completion remain pending; T-0181 original186 errno remains unknown.

Pack-path equivalence: actual `release publish . --pack` exited0 and created only the local root tarball; no Git push, GitHub Release or npm publication flags were present. Its bytes/SHA1/SHA256/SHA512 match the frozen artifact above. Packaged source diff against e856c57 remains empty. Final verify/check/lazy/encoding passed with0 failures/issues, and secrets scan retained0 unacknowledged/14 acknowledged synthetic findings.
Read-only performance follow-up: completed candidate4 Ubuntu18 job101370398328 took51m17s, of which E2E46m08s; Ubuntu22 job101370398370 took42m45s, of which E2E38m19s. Two completed logs only, no new suite execution or edits. The selftest JSON completion gaps were51-62s and the T-0090 surrounding gaps375/446s; these are timestamp intervals, not isolated case timings. Last green186 CI33959679140 Windows E2E durations were Node22 76m39s,24 87m01s,20 95m57s,18 102m08s (one historical run, not current ETA bounds). Parent checked the actual selftest spawn/cwd and T-0090 sandbox/repeat code. Two future measurement candidates were added to plan.md without deduplicating assertions, changing OS coverage, parallelizing current tests or claiming a measured speedup. Four selected source SHA256/mtime snapshots remained unchanged.

Intermediate local E2E session74472 completed exit1,465/467,6848s. Its source changed during execution, so it is not frozen e856c57 evidence. Preserved failures: original API1.36.74 ran before the standalone producer correction; 1.36.134 reported only one leftover temporary probe file. Read-only follow-up found that134 points child TMPDIR/TEMP/TMP to its own sb but counts every parent os.tmpdir() entry matching leerness-probe-. The observed regular non-linked file was leerness-probe-26132-1788641571904.sh,2221bytes, created/modified2026-09-05T20:52:51.9018047Z; PID26132 is no longer present. Its creator is unconfirmed, and neither this134 block nor concurrent final core is proven responsible. No contents were opened, no file was removed, no failing assertion was suppressed, and the product probe generation/finally-unlink code is unchanged between ef41542 and e856c57. T-0182 planned tracks the observation-scope correction with required foreign-parent and real-child-residue controls before future implementation. Six frozen source files matched e856c57 in this read-only audit.
Latest final CI metadata:33993125006 has6 successes (both fast OS jobs plus four release-runtime jobs),0 observed failures and7 full E2E gates pending. The CLI refused a request for one completed job's log while the overall run remained active; no individual log counts were inferred from that unavailable output. `verify-claim T-0180 --require-evidence --json` exited0 with six files present, evidence complete, reasons empty, implementation substance true; semanticVerified=false/testCountMatch=null. This is static evidence validation, not a full CI pass or a transition out of in-progress. Public187 is still unpublished.
```

## Agent / Model Provenance
- T-0180 final actual independent codex exec review01a07372-1fca-7df1-b717-4516e9f788bd: exit0/CLEAN, static only. Earlier findings and applied corrections are retained in review-evidence.md. The following dispatch.prepared records do not prove execution or completed review.
...
- 2026-09-05T17:53:52 dispatch.prepared · role=- · agy
- 2026-09-05T17:53:53 dispatch.prepared · role=- · claude
- 2026-09-05T17:54:06 dispatch.prepared · role=- · claude
- 2026-09-05T20:08:04 dispatch.prepared · role=- · agy
- 2026-09-05T20:08:05 dispatch.prepared · role=- · claude
- 2026-09-05T20:08:17 dispatch.prepared · role=- · claude

## Recommended Direction
- Continue the approved T-0180 compatibility slice and its release verification. M-0015 runtime activation and M-0016..M-0018 remain incomplete. Do not switch to the unrelated old i18n/router backlog merely because session close suggests it.

## Next Exact Step
- CI33993125006 for exact product SHA e856c57837f90b09048405df6a684190f7a1ff75 completed9 successes/4 Windows full E2E failures. Continue T-0182 actual-child TMP correction and Windows doctor/handoff diagnostics, then freeze/repack a new candidate. Do not combine passing jobs across earlier candidates. Latest core/installed and pack consumer checks on e856c57 remain measured history, not a final CI pass.
- If the required same-SHA CI passes, recheck remote main (last1805da9), absent v187 tag/release and frozen pack/source hashes, then publish/verify GitHub, npm latest/exact and the site. Do not use sync-main or overwrite saved main beb039d with its original five dirty files. Site has only generated data/releases.json and data/facts.json prepared;711-page build passed, no production187 deploy.
- Exact pack: C:/Users/leehy/AppData/Local/Temp/leerness-pack-187-e856c57-11c9d8d7525a4228af53d94f85ec9603/leerness-1.36.187.tgz (also same bytes at product root). SHA1 ff33b591eed0a2a2d5afa5895c97ccbfca87e820; SHA256 136e2b9dda1d9ce43e0b9029e5cecbb94be74ace9eaebc3999e241eb0bbd4107. All prior187 packs are obsolete.
- T-0182 in-progress: both foreign-parent false positive and real-child-sb false negative reproduced on four native Node versions; durable probe registered twice before the minimal correction. Original full134 verification is running. Node18 exact JSON121 doctor locally timed out at180s with ETIMEDOUT; original handoff20/doc-surface24 passed locally and their CI errno remains unknown. T-0181 original186 errno remains unknown. Actual migration B needs separate approval; no descriptor creation, activation, worktree cleanup or scheduler change occurred.

## Current Close Boundary
- Session close exited0 at2026-09-05T21:59:32Z and emitted all nine task categories. T-0180 and UR-0100 remain in-progress; no task was made done for pending CI/publication. R-0001 is backed by the actual independent review. R-0002's automatic pass checks only version186→187; public GitHub Release/npm/site verification remains pending.
- Existing pre-wake critical2 and unmatched request1 were retained; elapsed wakeup bookkeeping is not proof of a scheduler/process failure. No new automation or later callback was created. Required CI is already running remotely; this handoff records the exact continuation point without claiming a completed release.
- Post-close gate6/6, health/check healthy,150 old completed claims with68 unchanged historical baseline entries and0 new failures. Product source still matches e856c57; local changes are only governance/generated records. Remote main remains1805da9 and no v187 tag exists. Final observed CI6 passed/7 pending; do not mark T-0180 done or R-0002 fulfilled yet.
