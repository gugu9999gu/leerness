...
[![npm](https://img.shields.io/badge/npm-leerness-blue)](https://www.npmjs.com/package/leerness) [![version](https://img.shields.io/badge/version-1.9.225-green)]() [![tests](https://img.shields.io/badge/e2e-217%2F217-success)]() [![stress](https://img.shields.io/badge/stress--v170-14%2F14-success)]() [![mcp](https://img.shields.io/badge/MCP--tools-61-brightgreen)]() [![rounds](https://img.shields.io/badge/autonomous--rounds-155-blueviolet)]() [![main-push](https://img.shields.io/badge/release--main--push-87_rounds-success)]() [![goal-matrix](https://img.shields.io/badge/목적_매트릭스-100%2F100_(5축)-brightgreen)]() [![drift-fix](https://img.shields.io/badge/🔧_drift--auto--fix-delivered_통합-blueviolet)]() [![perf](https://img.shields.io/badge/cold_start-367ms-success)]() [![install](https://img.shields.io/badge/npm_i_leerness-즉시_사용_가능-success)]() [![sandbox](https://img.shields.io/badge/runCommandSafe-cwd_jail%2Benv_scrub-success)]() [![license](https://img.shields.io/badge/license-MIT-lightgrey)]()
...
```
  ...
  ║  ███████╗███████╗███████╗██║  ██║██║ ╚████║███████╗███████║  ║
  ║  ╚══════╝╚══════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═══╝╚══════╝╚══════╝  ║
  ║  v1.9.225  AI Agent Reliability Harness + Sandbox            ║
  ║  verify · remember · orchestrate · audit · sandbox · drift   ║
  ║  🔧 drift --auto-fix delivered + AUTO_APPLY env opt-in      ║
  ╚══════════════════════════════════════════════════════════════╝
```
