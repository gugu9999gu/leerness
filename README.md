...
[![npm](https://img.shields.io/npm/v/leerness)](https://www.npmjs.com/package/leerness) · ![MCP tools](https://img.shields.io/badge/MCP--tools-88-blue) · **0 runtime deps** · **0 install scripts** · offline-first · Node ≥ 18 · MIT
...
Leerness v1.36.76는 stdio JSON-RPC MCP server를 내장합니다 — Claude Code · Cursor · Codex CLI 등 외부 AI에 **88개 도구**를 노출:
