...
[![npm](https://img.shields.io/badge/npm-leerness-blue)](https://www.npmjs.com/package/leerness) [![version](https://img.shields.io/badge/version-1.9.210-green)]() [![tests](https://img.shields.io/badge/e2e-217%2F217-success)]() [![stress](https://img.shields.io/badge/stress--v155-18%2F18-success)]() [![mcp](https://img.shields.io/badge/MCP--tools-54-brightgreen)]() [![rounds](https://img.shields.io/badge/autonomous--rounds-140-blueviolet)]() [![main-push](https://img.shields.io/badge/release--main--push-72_rounds-success)]() [![goal-matrix](https://img.shields.io/badge/목적_매트릭스-98%2F100_(5축)-brightgreen)]() [![adaptive](https://img.shields.io/badge/wakeup-adaptive_10~45min-success)]() [![perf](https://img.shields.io/badge/cold_start-440ms-success)]() [![install](https://img.shields.io/badge/npm_i_leerness-즉시_사용_가능-success)]() [![sandbox](https://img.shields.io/badge/runCommandSafe-cwd_jail%2Benv_scrub-success)]() [![license](https://img.shields.io/badge/license-MIT-lightgrey)]()
...
```
  ...
  ║  ███████╗███████╗███████╗██║  ██║██║ ╚████║███████╗███████║  ║
  ║  ╚══════╝╚══════╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═══╝╚══════╝╚══════╝  ║
  ║  v1.9.210  AI Agent Reliability Harness + Sandbox            ║
  ║  verify · remember · orchestrate · audit · sandbox · drift   ║
  ║  ⚡ adaptive wakeup 10~45min (활동 기반 자동) (사용자 명시)          ║
  ╚══════════════════════════════════════════════════════════════╝
```
